...
export const fr: Messages = {
    ...
    "connect.discover.cancel": "Annuler",
    "connect.discover.notFound": "Aucun PC trouvé. Vérifie que Mimic Conduit est lancé et que tu es sur le même Wi-Fi, ou scanne le QR code.",
    ...
    "cs.skins": "Skins",
    "cs.reroll": "Relancer",
    "cs.trade.incoming": "{name} veut échanger contre {champion}",
    "cs.trade.accept": "Accepter",
    "cs.trade.decline": "Refuser",
    ...
    "runes.rename": "Renommer la page",
    "runes.newPage": "Nouvelle page",
    "runes.deletePage": "Supprimer la page",
    "runes.deleteConfirm": "Supprimer la page de runes « {name} » ?",
